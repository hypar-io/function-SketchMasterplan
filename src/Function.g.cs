...
namespace SketchMasterplan
{
    public class Function
    {
        ...
        private IModelStore<SketchMasterplanInputs> store;

        public async Task<SketchMasterplanOutputs> Handler(SketchMasterplanInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<SketchMasterplanInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<SketchMasterplanInputs,SketchMasterplanOutputs>(store, SketchMasterplan.Execute);
