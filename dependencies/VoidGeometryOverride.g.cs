...
{
	/// <summary>
	/// Override metadata for VoidGeometryOverride
	/// </summary>
	public partial class VoidGeometryOverride : IOverride
	{
        public static string Name = "Void Geometry";
	...
	public static class VoidGeometryOverrideExtensions
    {
		/// <summary>
        /// Apply Void Geometry edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Void Geometry Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<VoidGeometryOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, VoidGeometryIdentity, bool> identityMatch,
            Func<T, VoidGeometryOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Void Geometry Overrides to apply — typically `input.Overrides.VoidGeometry`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<VoidGeometryOverride> overrideData,
            Func<T, VoidGeometryIdentity, bool> identityMatch,
            Func<T, VoidGeometryOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.VoidGeometry)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.VoidGeometry)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.VoidGeometry)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<VoidGeometryOverride> edits,
            IList<VoidGeometryOverrideAddition> additions,
            IList<VoidGeometryOverrideRemoval> removals,            Func<VoidGeometryOverrideAddition, T> createElement,
            Func<T, VoidGeometryIdentity, bool> identityMatch,
            Func<T, VoidGeometryOverride, T> modifyElement,
